...
echo "  pnpm dev:admin        - Start admin dashboard (http://localhost:3000)"
echo "  pnpm dev:analytics    - Start analytics dashboard (http://localhost:3001)"
echo "  pnpm dev:portal       - Start public portal (http://localhost:3002)"
