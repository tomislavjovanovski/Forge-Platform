...
import { SettingsForm, type FormField } from '@forge/ui';
...
/**
 * SettingsForm provides a complete form for application settings with validation and error handling
 * 
 * Features:
...
export const WithValidationErrors: Story = {
  args: {
    ...
    fields: [
      ...SAMPLE_FIELDS.map((f) =>
        f.name === 'email'
          ? { ...f, error: 'Please enter a valid email address' }
          : f
      ),
    ],
  },
...
/**
 * Interactive demo - try submitting the form to see loading state
 */
