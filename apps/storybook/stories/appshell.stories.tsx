...
import { AppShell, PageContainer } from '@forge/ui';
  ...
  <div className="space-y-4">
    <div className="rounded-lg border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
      ...
      <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
        The AppShell pattern provides a complete application layout structure with responsive sidebar and header.
      </p>
    </div>
  </div>
);
...
/**
 * AppShell provides the primary layout structure for applications
 * 
 * Features:
